...
export const ProcessingSection: React.FC<ProcessingSectionProps> = React.memo(({
  loadingStep,
  loadingMessages
}) => (
  <motion.div 
  ...
  >
    <div className="relative">
      <div className="w-24 h-24 rounded-full border-2 border-dashed border-white/10 animate-[spin_10s_linear_infinite]" aria-hidden="true" />
    ...
    <div className="text-center space-y-2">
      ...
      <div className="w-48 h-1 bg-white/5 rounded-full overflow-hidden mx-auto" aria-hidden="true">
        <motion.div 
